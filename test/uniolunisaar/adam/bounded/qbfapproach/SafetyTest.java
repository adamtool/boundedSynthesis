...
public class SafetyTest {
	...
	public void test() throws Exception {
		...
		//oneTest("firstExamplePaper/firstExamplePaper_extended", 5, 3, false); TRUE
		oneTest("firstExamplePaper/firstExamplePaper", 5, 3, true);
		//oneTest("firstExamplePaper/firstExamplePaper", 4, 3, false); TRUE
		...
		//oneTest("firstExamplePaper/firstExamplePaper", 10, 2, false); TRUE
		oneTest("jhh/myexample1", 10, 0, false);
		//oneTest("jhh/myexample1", 10, 2, false); TRUE
	}
